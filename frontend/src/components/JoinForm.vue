<template>
  <div class="w-full max-w-xs md:max-w-lg">
    ...
    >
      <div class="mb-4">
        <label
          class="block text-center text-gray-700 font-bold mb-2 select-none"
          for="username"
        >
          Username
        </label>
      ...
      <div class="mb-6">
        ...
        <div class="flex flex-row w-full bg-white shadow border rounded pr-2">
          ...
          <div @click="randomChatroom" class="icon">
            <dice-icon
              class="h-full hover-cursor text-gray-700 hover:text-black"
              size="24"
            />
          </div>
        </div>
      </div>
      <Button extendStyle="font-bold w-full select-none" type="submit"
        >Join</Button
      >
    </form>
  </div>
